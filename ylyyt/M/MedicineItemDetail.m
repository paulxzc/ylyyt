...
@implementation MedicineItemDetail
...
+ (MedicineItemDetail *)medicineItemDeatailWithDic:(NSDictionary*)dic{
    MedicineItemDetail *medicineItemDetail = [[MedicineItemDetail alloc] initWithDic:dic];
    return medicineItemDetail;
}
@end
