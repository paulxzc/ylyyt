...
- (void)viewDidLoad {
    ...
    [[AFAppDotNetAPIClient sharedClient] GET:[NSString stringWithFormat:@"api_itemList.xml"] parameters:nil success:^(NSURLSessionDataTask *task, NSXMLParser *responseObject) {
