...
- (void)viewDidLoad {
    ...
    [[AFAppDotNetAPIClient sharedClient] GET:[NSString stringWithFormat:@"api_itemOrderList.xml"] parameters:nil success:^(NSURLSessionDataTask *task, NSXMLParser *responseObject) {
