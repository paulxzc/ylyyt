...
#pragma mark --下载数据
    ...
    [[AFAppDotNetAPIClient sharedClient] GET:[NSString stringWithFormat:@"api_homepage.xml"] parameters:nil success:^(NSURLSessionDataTask *task, NSXMLParser *responseObject) {
